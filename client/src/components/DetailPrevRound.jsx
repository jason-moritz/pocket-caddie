        ...
        <div className="text-gray-100">
            ...
            <div className="flex flex-row justify-center">
                <div className="flex flex-col items-center px-4 md:flex flex-row">
                    ...
                    <DisplayHole title="Hole 4" score={h4} />
                    <DisplayHole title="Hole 5" score={h5} />
                    <DisplayHole title="Hole 6" score={h6} />
                ...
                <div className="flex flex-col items-center px-4 md:flex flex-row">
                    ...
                    <DisplayHole title="Hole 13" score={h13} />
                    <DisplayHole title="Hole 14" score={h14} />
                    <DisplayHole title="Hole 15" score={h15} />
