        ...
        <form className="text-gray-100 w-screen mt-5" onSubmit={courseName && rating && slope ? handleSubmit : handleToggle}>
            <div className="flex justify-center">
                <div className="w-3/4 max-w-2xl">
                    ...
                    <input className="block shadow-lg appearance-none rounded-md mb-4  text-gray-md bg-gray-100 w-full leading-6 hover:scale-50 focus:outline-none focus:shadow-outline" value={courseName} onChange={twoCallsCourse} />
                    {toggle1 > 0 ? <p className="text-sm text-red-500">Please enter a course name</p> : null}
                    <label>Photo</label>
                    <input className="block shadow-lg appearance-none rounded-md mb-4  text-gray-md bg-gray-100 w-full leading-6 hover:scale-50 focus:outline-none focus:shadow-outline" value={courseImage} onChange={e => setCourseImage(e.target.value)} />
                    <label>Rating</label>
                    <input className="block shadow-lg appearance-none rounded-md mb-4  text-gray-md bg-gray-100 w-full leading-6 hover:scale-50 focus:outline-none focus:shadow-outline" value={rating} onChange={twoCallsRating} />
                    {toggle2 > 0 ? <p className="text-sm text-red-500">Please enter a rating</p> : null}

                    <label>Slope</label>
                    <input className="block shadow-lg appearance-none rounded-md mb-4  text-gray-md bg-gray-100 w-full leading-6 hover:scale-50 focus:outline-none focus:shadow-outline" value={slope} onChange={twoCallsSlope} />
