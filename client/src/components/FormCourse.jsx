...
export default function CourseForm(props) {
    ...
    return (
        <form className="text-gray-100 w-screen" onSubmit={courseName && rating && slope ? handleSubmit : handleToggle}>
            <div className="flex justify-center">
                <div className="w-3/4 max-w-2xl">
                    <label>Course Name</label>
                    <input className="block shadow-lg appearance-none rounded-md mb-4  text-gray-500 bg-gray-100 w-full leading-6 hover:scale-50 focus:outline-none focus:shadow-outline" value={courseName} onChange={twoCallsCourse} />
                    ...
                    <label>Rating</label>
                    <input className="block shadow-lg appearance-none rounded-md mb-4  text-gray-500 bg-gray-100 w-full leading-6 hover:scale-50 focus:outline-none focus:shadow-outline" value={rating} onChange={twoCallsRating} />
                    {toggle2 > 0 ? <p className="text-sm text-red-500">Please enter a rating</p> : null}

                    <label>Slope</label>
                    <input className="block shadow-lg appearance-none rounded-md mb-4  text-gray-500 bg-gray-100 w-full leading-6 hover:scale-50 focus:outline-none focus:shadow-outline" value={slope} onChange={twoCallsSlope} />
