        ...
        <form className="text-gray-100 w-screen mt-5" onSubmit={handleSubmit}>
            <div className="flex justify-center">
                <div className="w-3/4 max-w-2xl">                    
                    ...
                    <label>Hole 18</label>
                    <input className="block shadow-lg appearance-none rounded-md mb-4  text-gray-md bg-gray-100 w-full leading-6 focus:outline-none focus:shadow-outline" value={h18} onChange={twoCalls} />
                    <div className="flex justify-center">
